...
import dreImgae from '../../dre.jpg';

class ImgInfor extends Component {
  render() {
    return (
      <section>
        <div>
          <div><img src={dreImgae} alt="avatar" class="avatar"/></div>
        </div>
        <div>
          <div class="my-name">Andre Madarang</div>
          <div my="title">Full Stack Web Developer</div>
          <div class="links">
            <div class="link-item">
            ...
            <div class="link-item">
              ...
              <a href="http://google.ca">email@email.com</a>
            </div>
            <div class="link-item">
              ...
              <a href="http://google.ca">123-456-7890</a>
            </div>
            </div>
